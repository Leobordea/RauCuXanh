...
namespace RauCuXanh.Effects
{
    static class PopupSize
    {
        ...
        public static Size Custom => new Size(1 * (DeviceDisplay.MainDisplayInfo.Width / DeviceDisplay.MainDisplayInfo.Density), 0.3 * (DeviceDisplay.MainDisplayInfo.Height / DeviceDisplay.MainDisplayInfo.Density));
